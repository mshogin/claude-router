...
- **`ccr`** (`@musistudio/claude-code-router`, `:3456`) — translates Claude Code's Anthropic API into OpenAI-shaped requests, multiplexes across providers. Uses our `lib/router.js` as `CUSTOM_ROUTER_PATH` for scoring.
